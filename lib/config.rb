...
class Config
  ...
  MAPPING_METHODS = %i[
    git_mappings zsh_mappings nvim_mappings ghostty_mappings tmux_mappings ruby_mappings
    psql_mappings cursor_mappings bin_mappings
  ].freeze
  ...
  def bin_mappings
    {
      dotfiles_path("bin", "opencode-dev") => home_path(".local", "bin", "opencode-dev"),
      dotfiles_path("bin", "opencode-dev-web") => home_path(".local", "bin", "opencode-dev-web")
    }
  end
end
